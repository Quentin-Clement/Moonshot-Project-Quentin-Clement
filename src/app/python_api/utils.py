...
correct = cv2.imread('/Users/quentinclement/Documents/GitHub/squats-analysis/right.png')
correct = cv2.cvtColor(correct, cv2.COLOR_BGR2RGB)
incorrect = cv2.imread('/Users/quentinclement/Documents/GitHub/squats-analysis/wrong.png')
